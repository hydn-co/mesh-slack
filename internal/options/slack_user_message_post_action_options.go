...
type SlackUserMessagePostActionOptions struct {
	...
	Emails []string `json:"emails" title:"Recipient Email(s)" description:"One to eight recipient email addresses used to open a direct or group message" binding:"required"`
}
